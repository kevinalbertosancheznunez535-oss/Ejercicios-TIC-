Algoritmo Cine
	...
	escribir "cabe aclarar que para peliculas de suspenso o terror, no estar sufriendo algun tipo de problema cardiaco o psicologico"
	escribir "Royale Films NO SE HACE RESPONSABLE DE DAÑOS PSICOLOGICOS O CARDIACOS }:)"
FinAlgoritmo
